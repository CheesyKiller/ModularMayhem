...
import GLFWNullPlatform;
#define GLFW_EXPOSE_NATIVE_EGL
#define GLFW_EXPOSE_NATIVE_OSMESA

#if defined(_GLFW_WIN32)
import win32_platform;
...
import null_joystick;

#if defined(_GLFW_WIN32)
import win32_joystick;
#else
